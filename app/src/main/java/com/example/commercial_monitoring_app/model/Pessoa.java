...
public class Pessoa {
    ...
    public String getPessoaprincipal_id() {
        return pessoaprincipal_id;
    }

    public void setPessoaprincipal_id(String pessoaprincipal_id) {
        this.pessoaprincipal_id = pessoaprincipal_id;
    }
    ...
    public String getGrauinstrucao_id() {
        return grauinstrucao_id;
    }

    public void setGrauinstrucao_id(String grauinstrucao_id) {
        this.grauinstrucao_id = grauinstrucao_id;
    }
    ...
    public String getOutrasdeficiencias() {
        return outrasdeficiencias;
    }

    public void setOutrasdeficiencias(String outrasdeficiencias) {
        this.outrasdeficiencias = outrasdeficiencias;
    }
    ...
    public String getExaluno() {
        return exaluno;
    }

    public void setExaluno(String exaluno) {
    ...
    public void setCanhoto(String canhoto) {
    ...
    public String getDesinscreveu() {
        return desinscreveu;
    }

    public void setDesinscreveu(String desinscreveu) {
        this.desinscreveu = desinscreveu;
    }
